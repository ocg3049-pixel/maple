...
const inspect = (path) => {
  ...
  console.log(path + ':  ap=(' + (ap?ap.x:'-') + ',' + (ap?ap.y:'-') + ')  size=(' + (size?size.x:'-') + 'x' + (size?size.y:'-') + ')  offset_y=[' + (omin?omin.y:'-') + ',' + (omax?omax.y:'-') + ']');
};

// StarforceContent 및 그 contents
...
inspect('EnhanceWindow/RightPanel/ContentArea/StarforceContent/Star_10');
inspect('EnhanceWindow/RightPanel/ContentArea/StarforceContent/Star_11');
inspect('EnhanceWindow/RightPanel/ContentArea/StarforceContent/Star_100');
inspect('EnhanceWindow/RightPanel/ContentArea/StarforceContent/LevelArrow');
inspect('EnhanceWindow/RightPanel/ContentArea/StarforceContent/EnhanceLevelText');
inspect('EnhanceWindow/RightPanel/ContentArea/StarforceContent/StatHeader');
inspect('EnhanceWindow/RightPanel/ContentArea/StarforceContent/StatsText');
inspect('EnhanceWindow/RightPanel/ContentArea/StarforceContent/RateHeader');
...
inspect('EnhanceWindow/RightPanel/ContentArea/StarforceContent/CostText');
